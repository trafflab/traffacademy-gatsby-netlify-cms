...
opening:
  cards:
    ...
    - title: Почему запуск рекламы в интернете доступен каждому?
...
whatIsIt:
  ...
  text: Запуск рекламы в интернете - это возможность зарабатывать на привлечении
    клиентов в разные сферы бизнеса
  title:
    - part: Что такое
    - part: таргетированная реклама?
  cards:
    - text: Свобода в выборе рабочего графика и локацииghbdwewe
...
importantThings:
  ...
  cards:
    - cardImage: /img/important-things/1.png
      ...
      text: Что такое таргетированная реклама и почему она так востребована у
        заказчиков
