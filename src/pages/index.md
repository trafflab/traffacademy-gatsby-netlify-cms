...
opening:
  cards:
    - title: 3 дня - 3 урока
      text: Усвоите базовые принципы заработка на арбитраже трафика
    - title: Практика
      text: Научитесь одной из главных функций - выбор продукта
    - title: Получите набор для эффективного старта
      text: Чек-листы, таблицы и инструкции
...
whatIsIt:
  ...
  cards:
    ...
    - text: Независимость вашего заработка от заказчиков и полная свобода действий
...
participate:
  ...
  title: "Живые встречи "
  subtitle: без записей!
  text: На курсе вы сможете задать все интересующие вопросы Тамерлану и
