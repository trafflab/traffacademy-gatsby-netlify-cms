...
opening:
  ...
  giftText: Зарегистрируйся и получи гайд &nbsp; «5 шагов для заработка от 100 000
    ₽ в месяц в онлайне»
  buttonText: Участвовать бесплатно
whatIsIt:
  image_480: /img/what-is-it/image_480.png
  text: В двух словах, партнерский маркетинг  позволяет зарабатывать на
    привлечении клиентов в разные сферы бизнеса
  title:
    - part: Что такое
